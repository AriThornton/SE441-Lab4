...
3)	Screenshot after log in.
    ...
    ![image](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image.png?raw=true)
...
1)	The build failed. 
    ...
    ![image 1](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-1.png?raw=true)
...
3)	It seems like the failure was mac specific, so in order to fix it, I added export PATH="/opt/homebrew/bin:/usr/local/bin:$PATH" because of the homebrew not found message.
    ...
    ![image 2](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-2.png?raw=true)

# Part 3 – Chained Free-Style Workflow
## Create a Jenkins build job:
1)	The build passed.

    ![image 3](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-3.png?raw=true)
...
1)	The build technically passed but there was still an error during the processing. 
    ...
    ![image 4](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-4.png?raw=true)
...
1)	The initial build in both ASCII-BuildJob and ASCII-TestJob passed.
    ...
    ![image 5](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-5.png?raw=true)

    ![image 6](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-6.png?raw=true)
...
1)	Builds initially failed.
    ...
    ![image 7](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-7.png?raw=true)

    ![image 8](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-8.png?raw=true)
...
3)	I fixed this by updating the post-build actions in ASCII-BuildJob to archive joke.json.
    ...
    ![image 9](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-9.png?raw=true)

    ![image 10](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-10.png?raw=true)

## Check workspace for test job:
1)	The initial builds passed.

    ![image 11](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-11.png?raw=true)

    ![image 12](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-12.png?raw=true)

## Create a deployment job:
1)	Console output after building ASCII-DeployJob.

    ![image 13](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-13.png?raw=true)
...
1)	When you click build now it just keeps loading.
    ...
    ![image 14](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-14.png?raw=true)
...
5)	If it fails, I think the first place you should look is the console output for the error and then at the configuration to see if anything needs changed or updated, and tehn look at github.
    ...
    ![image 15](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-15.png?raw=true)
 
# Part 6 – Pipeline with Parameters
1)	I am unable to access the GitHub Classroom to complete part 6.

    ![image 16](https://github.com/AriThornton/SE441-Lab4/blob/main/screenshots/image-16.png?raw=true)
